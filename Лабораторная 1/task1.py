...
class Teacher:
    ...
    def __init__(self, speciality: str, experience: int):
         ...
         if experience < 20:
             raise ValueError("Слишком молодой учитель или недопустимый возвраст")
...
class Student:
    ...
    """
    def __init__(self, age: int, favorite_subject: str):
        """ Инициализация экземпляра класса.
         :param age: возраст ученика
         :param favorite_subject: любимая дисциплина (урок) ученика
         """
        if age > 19:
        ...
        if age < 5:
            raise ValueError("Недопустимый возраст ученика")
        self.age = age
        self.favorite_science = favorite_subject
